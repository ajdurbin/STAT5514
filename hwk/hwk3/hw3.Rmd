...
\begin{align*}
E(Y - \hat{Y}) &= exp \Bigg\{ \beta_0 + \beta_1X + \frac{1}{2}\sigma^2 \Bigg\} - exp \Bigg\{ \beta_0 + \beta_1X + \frac{1}{2}\sigma^2[\frac{1}{n} + \frac{\bar{x}^2}{S_{xx}} + \frac{x^2}{S_{xx}}] \Bigg\} \\
&\ne 0.
\end{align*}
...
&= \sigma^2 \Bigg[ 1 - \frac{1}{n} - \frac{\bar{x}^2}{S_{xx}} - \frac{x^2}{S_{xx}}  \Bigg] \\
& \ne 0.
...
Our true underlying model is $\frac{1}{Y} = \beta_0+\beta_1X+\epsilon$. We then use the identity in the paper to approximate $E(Y) = \frac{1}{\beta_0+\beta_1X} \Big\{ 1 + \frac{\sigma^2}{(\beta_0+\beta_1X)^2} \Big\}$. If we fit $\frac{1}{\hat{Y}} = \hat{\beta}_0+\hat{\beta}_1X$, then using the same identity, we see $E(\hat{Y}) = \frac{1}{\beta_0+\beta_1X} \Big\{ 1 + \frac{\sigma_\beta^2}{(\beta_0+\beta_1X)^2} \Big\}$, where $\sigma_\beta^2 = \sigma^2[\frac{1}{n} + \frac{\bar{x}^2}{S_{xx}} + \frac{x^2}{S_{xx}}]$. It is easy to see that the bias is nonzero also. Indeed
