...
DISCLAIMER: Cauchy draws are extremely variable, I had draws resulting in MSE less than 900 for both coefficients, but another draw that had MSE over 20000 for each coefficient.

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, cache = FALSE)
options(stringsAsFactors = FALSE, scipen = 1E10)
```
...
# knitr::kable(b0_mse, row.names = c('lse normal', 'lse lognormal', 'lse cauchy', 'rlm normal', 'rlm lognormal', 'rlm cauch', 'lad normal', 'lad lognormal', 'lad cauchy', 'lts normal', 'lts lognormal', 'lts cauchy'))

# knitr::kable(b1_mse, row.names = c('lse normal', 'lse lognormal', 'lse cauchy', 'rlm normal', 'rlm lognormal', 'rlm cauch', 'lad normal', 'lad lognormal', 'lad cauchy', 'lts normal', 'lts lognormal', 'lts cauchy'))
